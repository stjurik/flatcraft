...
> **TODO (окремий майбутній PR):** деплой Umami-контейнера + окрема БД у наявному Postgres —
> `infra/compose` + `infra/ansible` (CLAUDE.md §6 — не чіпати без згоди). Тригер перегляду стеку
> аналітики: понад 500K подій/міс (ADR-032 §4).
