...
6. Напрям згину (UP/DOWN) задано для кожного гибу — рендериться на креслі стрілкою у bend-table і поряд з callout на розгортці (дефолт `down`; Hotfix 2.10.e, ADR-019).
