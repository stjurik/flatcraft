...
_Останнє оновлення: 2026-05-30. Коли архітектура змінюється — оновлюйте цей файл першим, потім код._
